<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Master_Source.master" AutoEventWireup="true" CodeFile="ProjectList.aspx.cs" Inherits="admin_ProjectList" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="userNameLabel" runat="server" Text='<%# Eval("projectname") %>'  NavigateUrl='<%# Eval("id") %>' OnDataBinding="FixNameUrl" ForeColor="#333333" />
                    </td>
                    <td>
