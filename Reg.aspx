        ...
        <table border="0" width="100%" style="margin: auto">
            <tr>
                ...
                <td rowspan="8">
                    <h3>
                        用户注册协议</h3>
                    <span class="Apple-style-span" style="color: rgb(51, 51, 51); font-family: Arial;
                        font-size: 12px; font-style: normal; font-variant: normal; font-weight: normal;
                        letter-spacing: normal; line-height: 18px; orphans: 2; text-align: -webkit-auto;
                        ...
                        欢迎您加入本站点参加交流和讨论，本站点为公共论坛，为维护网上公共秩序和社会稳定，请您自觉遵守以下条款：<span class="Apple-converted-space">&nbsp;</span><br />
                        <br />
                        ...
                        五、如果您有违反国家相关法律法规的行为，本站概不负责，您的登录论坛信息均被记录无疑，必要时，我们会向相关的国家管理部门提供此类信息。</span>
                </td>
                <td>
                    &nbsp;
                </td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <td height="60" width="110" align="right">
                            <asp:TextBox ID="tb_UserName" runat="server" OnTextChanged="tb_UserName_TextChanged"
            ...
            <tr>
                ...
                <td height="60">
                    &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="tb_Password"
                        ControlToValidate="tb_ConfirmPwd" ErrorMessage="&lt;img src=&quot;/images/regwrong.png&quot;&gt;两次输入的密码不一致。"
            ...
            <tr>
                ...
                <td height="60">
                    &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                        ControlToValidate="tb_Email" ErrorMessage="&lt;img src=&quot;/images/regwrong.png&quot;&gt;邮箱地址不正确。"
            ...
            <tr>
                <td align="center" colspan="3" class="style1">
                    <asp:CheckBox ID="cb_Agree" runat="server" Text="我已阅读并完全条款内容" TabIndex="6" Checked="True" />
                </td>
            ...
            <tr>
                <td colspan="3" height="80">
                    <div align="center">
                        <asp:Button ID="btn_Submit" runat="server" CssClass="zbutton" Text="提交注册" OnClick="btn_Submit_Click"
                            ValidationGroup="a" />
                        &nbsp;</div>
                </td>
